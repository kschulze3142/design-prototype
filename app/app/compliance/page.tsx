      ...
      <Card className="px-7 py-6 mb-6">
        <div className="flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-[40px] leading-[1.05] font-semibold tracking-tight text-slate-900 mt-1.5" style={{ fontFamily: 'var(--font-inter-tight), system-ui', letterSpacing: '-0.025em' }}>HIPAA-ready, by default.</h1>
            ...
            {[
              ...
              return (
                <div key={i} className="flex items-center gap-4 p-4 rounded-2xl border border-slate-200/70 bg-white/70">
                  ...
                  <button className="w-9 h-9 rounded-xl hover:bg-slate-100 flex items-center justify-center text-slate-500"><I.Download size={15} /></button>
                  <button className="w-9 h-9 rounded-xl hover:bg-slate-100 flex items-center justify-center text-slate-500"><I.More size={15} /></button>
                </div>
              );
            })}
          </div>
      ...
      <Card className="mt-6 overflow-hidden">
        ...
        <div className="overflow-auto scrollbar-thin">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {SUBPROCESSORS.map(s => (
                <tr key={s.name} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/70 transition">
