// d4 FeatureSplit — one idea per section. Headline + customer quote on the left,
// a single focused product surface on the right. Lots of whitespace. The quote's
// left rule rides the TEAL workhorse — it sits right under an orange eyebrow, so
// routing the rule to teal (rather than a blind coral→orange swap) keeps orange
// from clustering and holds the spark rare.
    ...
    <div style={{ maxWidth: 420 }}>
      ...
      <figure
        style={{
          margin: `${u(2.5)} 0 0`,
          paddingLeft: u(2),
          borderLeft: '2px solid var(--rd-color-primary)',
        }}
      >
