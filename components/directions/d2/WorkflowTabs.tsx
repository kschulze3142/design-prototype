...
// d2 WorkflowTabs — Harvest's "All your workflows in one platform" section
// (DR-004h). A segmented row of ~5 tabs (Track / Review / Bill / Organize /
// Manage), each revealing a short label + body + "Learn more" alongside a product
// surface. Body copy here is intentionally Harvest-style placeholder — the layout
// reads true and we reskin to Robin Dock specifics in pass 2. Accessible tablist
    ...
    <Section>
      <div style={{ maxWidth: 640, marginBottom: u(5) }}>
        ...
        <h2
          style={{
            ...
            // Spec h2: 50px / 55px (≈1.1) / weight 400 / -2px (≈-0.04em).
          ...
          return (
            <button
              ...
              style={{
                ...
                // Coral underline under the active tab, overlapping the row hairline.
                boxShadow: selected ? 'inset 0 -2px 0 var(--rd-color-accent)' : 'none',
      ...
      <style>{`
        @media (max-width: 860px) {
          ...
          .d2-wf-panel > div:last-child { justify-content: flex-start !important; }
        }
      `}</style>
    </Section>
  );
