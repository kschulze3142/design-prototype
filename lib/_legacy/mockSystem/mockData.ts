...
export const mockWorkItems: WorkItem[] = [
  ...
  // ---------------------------------------------------------------------------
  // CLINICAL RESULTS (12) — FE-059. Reuses 6 IDs from earlier seed (preserves
  // cross-dept linkedItems from referrals & PA); adds 6 new items to hit the
  // 4 normal / 4 borderline / 4 critical distribution. State machine is
  // new → reviewing → (flagged | resolved); flagged is off-pipeline terminal.
  // ---------------------------------------------------------------------------
  {
    id: 'cr-marcus-echo', departmentType: 'clinical_results', patientId: 'pt-marcus',
    status: 'flagged', assignedTo: 'u-daniel',
    slaBreached: false, slaDueAt: inHours(12),
    docTags: ['Imaging'],
    linkedItems: [
      { itemId: 'ref-5', relationship: 'spawned_from' },
    ...
    metadata: {
      ...
      abnormalFlags: ['LVEF: 35% (L)', 'Global hypokinesis'],
    },
  },
  {
    id: 'cr-eleanor-bnp', departmentType: 'clinical_results', patientId: 'pt-eleanor',
    status: 'resolved', assignedTo: 'u-amelia',
    slaBreached: false, slaDueAt: null,
    docTags: ['Lab Results'],
  ...
  },
  {
    ...
    metadata: {
      ...
      abnormalFlags: ['Apical WMA at peak stress'],
    },
  },
  {
    id: 'cr-yvette-cmr', departmentType: 'clinical_results', patientId: 'pt-yvette',
    status: 'resolved', assignedTo: 'u-jordan',
    slaBreached: false, slaDueAt: inHours(24),
    docTags: ['Imaging'],
    ...
    metadata: {
      ...
      criticality: 'borderline',
      abnormalFlags: ['LGE: lateral wall', 'Pattern: NICM'],
    },
  },
  {
    id: 'cr-quincy-lipid', departmentType: 'clinical_results', patientId: 'pt-quincy',
    status: 'resolved', assignedTo: 'u-daniel',
    slaBreached: false, slaDueAt: null,
    docTags: ['Lab Results'],
  ...
  },
  {
    ...
    status: 'reviewing', assignedTo: 'u-sophia',
    ...
    metadata: {
      ...
      criticality: 'borderline',
      abnormalFlags: ['Ferritin: 14 (L)', 'TSAT: 11% (L)'],
    },
  },
  {
    id: 'cr-theodore-holter', departmentType: 'clinical_results', patientId: 'pt-theodore',
    status: 'new', assignedTo: 'u-daniel',
    slaBreached: false, slaDueAt: inHours(8),
    docTags: ['Lab Results'],
    linkedItems: [{ itemId: 'pa-theodore-ep', relationship: 'related' }],
    ...
    metadata: {
      ...
      criticality: 'critical',
      abnormalFlags: ['Max HR: 165 bpm', 'AF burden: 22%'],
    },
  },
  {
    id: 'cr-lillian-troponin', departmentType: 'clinical_results', patientId: 'pt-lillian',
    status: 'reviewing', assignedTo: 'u-sophia',
    slaBreached: false, slaDueAt: inHours(6),
    docTags: ['Lab Results'],
    linkedItems: [{ itemId: 'ref-10', relationship: 'related' }],
    createdAt: hoursAgo(14), updatedAt: hoursAgo(2),
    metadata: {
      resultType: 'lab',
      orderingProvider: 'Dr. Fatima Osei',
      receivedAt: hoursAgo(14),
      criticality: 'critical',
      abnormalFlags: ['Troponin I: 0.42 (H)', 'CK-MB: 8.2 (H)'],
    },
  },
  {
    id: 'cr-cordelia-cyto', departmentType: 'clinical_results', patientId: 'pt-cordelia',
    status: 'reviewing', assignedTo: 'u-amelia',
    slaBreached: false, slaDueAt: inDays(2),
    docTags: ['Pathology'],
    linkedItems: [{ itemId: 'ref-2', relationship: 'related' }],
    createdAt: daysAgo(1), updatedAt: hoursAgo(10),
    metadata: {
      resultType: 'pathology',
      orderingProvider: 'Dr. James Orin',
      receivedAt: daysAgo(1),
      criticality: 'borderline',
      abnormalFlags: ['Atypical squamous cells', 'Goblet cell hyperplasia'],
    },
  },
  {
    id: 'cr-greta-discharge', departmentType: 'clinical_results', patientId: 'pt-greta',
    status: 'new', assignedTo: null,
    slaBreached: false, slaDueAt: inHours(24),
    docTags: ['Discharge Summary'],
    linkedItems: [],
    createdAt: hoursAgo(5), updatedAt: hoursAgo(5),
    metadata: {
      resultType: 'other',
      orderingProvider: 'Dr. Robert Yuen',
  ...
  {
    id: 'cr-oscar-monitor', departmentType: 'clinical_results', patientId: 'pt-oscar',
    status: 'resolved', assignedTo: 'u-daniel',
    slaBreached: false, slaDueAt: null,
    docTags: ['Imaging'],
    linkedItems: [{ itemId: 'o-oscar-monitor', relationship: 'spawned_from' }],
  ...
  {
    id: 'cr-rosalind-path', departmentType: 'clinical_results', patientId: 'pt-rosalind',
    status: 'resolved', assignedTo: 'u-amelia',
    slaBreached: false, slaDueAt: null,
    docTags: ['Pathology'],
...
export const mockThreadEvents: ThreadEvent[] = [
  ...
  },
  {
    ...
    actor: 'u-amelia', timestamp: hoursAgo(8),
    payload: {
      fromStatus: 'reviewing', toStatus: 'resolved',
      transitionActions: ['Marked resolved', 'Linked to ref-1'],
      notes: null,
    },
  },
