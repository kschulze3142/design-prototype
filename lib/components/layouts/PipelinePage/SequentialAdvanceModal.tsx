...
// =============================================================================
// SequentialAdvanceModal — warning shown when a drag skips one or more
// intermediate lifecycle stages. Cancel reverts; Move anyway leaves the
// optimistic commit in place.
//
// Per FE-054 Decision O1, the orchestrator commits the move before this
// modal opens. Cancel re-commits back to the source status (which emits a
// second status_change ThreadEvent — documented quirk).
// =============================================================================
...
export type PendingDrop = {
  ...
  fromLabel: string;
  toLabel: string;
  skippedStages: string[];   // human-readable labels of skipped stages
};
...
export function SequentialAdvanceModal({ pendingDrop, onConfirm, onCancel }: Props) {
  return (
    <div
      onClick={onCancel}
      style={{
